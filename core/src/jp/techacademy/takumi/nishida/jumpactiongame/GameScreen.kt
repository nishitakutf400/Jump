...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    init {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.takumi.nishida.jumpactiongame")
    ...
    private fun createStage() {
        ...
        val enemyTexture = Texture("animal_bear_kowai.png")
        msound = Gdx.audio.newSound(Gdx.files.internal("monster5.mp3"))
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            val x2 = mRandom.nextFloat() * WORLD_WIDTH

            val enemy = Enemy(enemyTexture, 100,100,100,100)
            enemy.setPosition(x2 + mRandom.nextFloat()*4,y + mRandom.nextFloat()*9)
            mEnemys.add(enemy)
